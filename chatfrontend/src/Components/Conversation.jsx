...
const Conversation = () => {
  ...
  >
    {/* Sidebar */}
    <aside className="w-full max-w-md p-4 bg-[#3A3A3A] border border-gray-200 shadow-sm sm:p-8 dark:border-gray-700">
          ...
          <ul className="divide-y divide-gray-200 dark:divide-gray-700">
            {conversations.map((conversation, index) => (
              <li key={index} className="py-1">
                <button
                  className="w-full text-left hover:bg-gray-100 dark:hover:bg-[#4A4A4A] transition-colors duration-200 rounded-lg p-2"
                  onClick={() => {}}
                >
